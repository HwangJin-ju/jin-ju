					...
					if (menu == 1) { // 등록
						while (true) {
							...
							if (result) {
								...
								System.out.println("대여가능여부>> 바로 대여 가능한 책이면 Y를 입력해 주세요");
						...
						while (true) {
							...
							if (result) {
								...
								System.out.println("올바른 작가 이름을 입력하세요");
						...
						if (result != null) { // null이 아니다 -> 책이 있다
							...
							System.out.println("조회할 수 없는 이름입니다."); // 책이 없으면 -> 책제목 틀림
						}
